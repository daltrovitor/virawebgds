                ...
                <div className="max-w-4xl w-full space-y-12">
                    ...
                    <div className="bg-amber-50 border border-amber-100 p-6 rounded-[24px] flex items-center gap-4 max-w-2xl mx-auto">
                        ...
                        <p className="text-sm font-semibold text-amber-900 leading-relaxed">
                            Seus dados (<span className="font-black italic">clientes, proficionais e notas</span>) continuam salvos e seguros. Eles serão liberados instantaneamente após a renovação.
                        </p>
                    </div>
                </div>
            </main>
